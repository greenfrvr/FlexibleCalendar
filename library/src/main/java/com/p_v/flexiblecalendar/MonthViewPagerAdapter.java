...
public class MonthViewPagerAdapter extends PagerAdapter {
    ...
    public MonthViewPagerAdapter(Context context, int year, int month, FlexibleCalendarGridAdapter.OnDateCellItemClickListener onDateCellItemClickListener,
                                 boolean showDatesOutsideMonth, boolean decorateDatesOutsideMonth, int startDayOfTheWeek, boolean disableAutoDateSelection) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        GridView view = (GridView) LayoutInflater.from(context).inflate(R.layout.month_grid_layout, null);
